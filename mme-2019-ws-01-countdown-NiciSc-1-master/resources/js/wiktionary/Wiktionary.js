...
const SERVER_URL =
  ...
  AVAILABLE_LANGUAGES = ["en", "mg", "fr", "ru", "sh", "es", "zh", "de", "nl",
    "sv", "pl", "ku", "lt", "el", "it", "ca", "fi", "hu", "ta", "tr", "ko",
    "io", "hy", "kn", "pt", "vi", "sr", "ja", "chr", "hi", "th", "ro", "no",
    "id", "ml", "et", "my", "uz", "li", "cs", "or", "te", "eo", "fa", "ar",
    "jv", "az", "eu", "gl", "oc", "br", "da", "lo", "uk", "hr", "fj", "ky",
    "tg", "bg", "simple", "ps", "ur", "sk", "la", "cy", "wa", "vo", "is",
    "zh-min-nan", "af", "ast", "he", "scn", "tl", "sw", "fy", "pa", "nn", "lv",
    "bn", "co", "mn", "pnb", "ka", "nds", "sl", "sq", "lb", "bs", "nah", "sa",
    "kk", "tk", "sm", "mk", "km", "hsb", "be", "ms", "vec", "ga", "an", "wo",
    "ang", "tt", "mt", "yue", "sd", "gn", "mr", "ie", "so", "gd", "csb", "ug",
    "st", "roa-rup", "si", "hif", "ia", "mi", "ay", "kl", "fo", "jbo", "ln",
    "zu", "na", "gu", "gv", "kw", "rw", "ts", "ne", "om", "qu", "su", "ss",
    "ha", "iu", "am", "dv", "za", "tpi", "ik", "yi", "ti", "sg", "tn", "ks",
    "as", "mo", "pi", "als", "ab", "sn", "bh", "dz", "tw", "to", "bi", "yo",
    "bo", "rm", "xh", "aa", "sc", "bm", "ak", "cr", "av", "ch", "rn", "mh"
  ],
  DEFAULT_LANGUAGE = "en";
...
class WiktionaryClient {
   ...
   * a language code is invalid. If no language is given, DEFAULT_LANGUAGE is used.
   * 
   * @param {String} Language code to define which wiktionary should be used
   */
  setLang(lang) {
    if (lang === undefined) {
      ...
      throw new Error(
        "Invalid language code. Check [https://en.wikipedia.org/wiki/List_of_Wiktionaries] to see avialable languages."
        );
    }
  }
